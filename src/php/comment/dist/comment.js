...
var CommentModule = {
    ...
    renderComments: function (data) {
        ...
        data.forEach(function (item) {
            var media = $('<div class="media" />'),
                avatar = $('<img class="d-flex mr-3" src="comment/img/avatar.jpg" />'),
                title = $('<p class="comment-title">').html($('<strong/>').html(item.name)),
                comment = $('<p class="comment-text"/>').html(unescape(item.comment)),
    ...
    facebook: {
        ...
        init: function () {
            var self = this;
            if (window['FB'] && self.data.appId && self.data.appId != "") {
                FB.init({
    ...
    google: {
        login: function (callback) {
            var clientId = document.getElementById('comment-module').dataset['ggClientid'];
    ...
    initSubmitForm: function () {
        ...
        $('#comment-module form.form-reply').each(function () {
            ...
            form.bind('submit', function () {
                ...
                if (comment.length < 1) return alert('Nội dung bình luận không được để trống!'), false;
                ...
                if (!self.data.user.name) {
                    try {
                        ...
                        $('#infoForm').submit(function () {
                            ...
                            formData.comment = escape(comment);
    ...
    init: function () {
        ...
        try {
            console.log("init comment module");
