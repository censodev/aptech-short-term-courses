...
if ($name!='' && $phone!='')
{
    ...
    if (isset($_POST['slCenter'])) {
        $center = $_POST['slCenter'];
    }

    include 'phpmailer/mailconfig.php';

    smtpmailer($center, $from, $from_name, $subject, $content);
    smtpmailer("anh.ct@aprotrain.com", $from, $from_name, $subject, $content);
    smtpmailer("dovietdung.ws@gmail.com", $from, $from_name, $subject, $content);
    smtpmailer("iviet@iviet.vn", $from, $from_name, $subject, $content);
