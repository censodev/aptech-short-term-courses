<?php
    ...
    $formSubmitRedirect = BASE_URL.'/laptrinhjavascript/dang-ky-thanh-cong';
    $formSubmitSubject = 'Đăng ký khóa học Javascript';

    $fbComment = BASE_URL.'/laptrinhjavascript';
?>
...
<body>
        ...
        <div class="pt-4 d-flex justify-content-center flex-wrap">
            ...
            <div class="box p-3 flex-basis-40">
                ...
                <form class="d-flex flex-column" action="../mail/sendmail.php" method="POST">
                    ...
                    <button type="submit" class="btn btn-round bg-white text-main btn-lg text-bold px-5 align-self-end">NHẬN THÔNG TIN</button>
                </form>
    ...
    <section class="section-13 py-5 bg-white">
        <h3 class="text-center text-bold text-main">BẠN NGHĨ SAO VỀ KHÓA HỌC HTML & JAVASCRIPT?</h3>
